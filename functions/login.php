...
// logon form message
function pweb_login_form_message( $message ) {
    if ( empty($message) ){
        return '<p class="message"><span class="dashicons dashicons-warning"></span> Unauthorized access is prohibitted</p>';
    } else {
        return $message;
    }
}
...
add_filter( 'login_message', 'pweb_login_form_message' );
?>